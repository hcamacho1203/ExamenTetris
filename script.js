    ...
    (function () {
        ...
        var tetris = {
            ...
            init: function () {
                ...
                this.bindKeyEvents();
                this.play();
                this.iniciarSpeedIncreaseTimer();
            },
            initBoard: function () {
            ...
            iniciarSpeedIncreaseTimer: function () {
                var me = this;
            ...
            gameOver: function () {
                ...
                if (!gameOverSoundPlayed) {
                    var gameOverSound = document.getElementById('game_over');
                    gameOverSound.play();
            ...
            removeRow: function (y) {
                ...
                var lineaEliminadaSound = document.getElementById('linea_borrada');
                lineaEliminadaSound.play();
            },
